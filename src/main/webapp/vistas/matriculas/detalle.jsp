...
<div class="container mt-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <p><strong>Estado:</strong> <span class="badge bg-success"><c:out value="${matricula.estadoMatricula}" /></span></p>
        </div>
    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <select name="idCurso" id="idCurso" class="form-select" required>
                            ...
                            <c:forEach var="curso" items="${listaCursos}">
                                <option value="${curso.idCurso}"><c:out value="${curso.nombreCurso}" /></option>
                            </c:forEach>
                        </select>
                    </div>
    ...
    <c:forEach var="detalle" items="${detalles}">
        <div class="card mb-3">
            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                <h4><c:out value="${detalle.nombreCurso}" /> (<c:out value="${detalle.creditosCurso}" /> créditos)</h4>
